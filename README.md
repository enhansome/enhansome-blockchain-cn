...
*Please read the contribution [guidelines](https://github.com/sindresorhus/awesome/blob/master/contributing.md) ⭐ 508,318 | 🐛 106 | 📅 2026-09-02 before contributing. 请在为本项目贡献信息前仔细阅读 [操作指南](https://github.com/sindresorhus/awesome/blob/master/contributing.md) ⭐ 508,318 | 🐛 106 | 📅 2026-09-02*
...
* [NEO](https://github.com/neo-project/neo) ⭐ 3,535 | 🐛 263 | 🌐 C# | 📅 2026-09-20 NEO链源码
* [FISCO-BCOS](https://github.com/FISCO-BCOS/FISCO-BCOS) ⭐ 2,606 | 🐛 420 | 🌐 C++ | 📅 2026-09-21 来自金链盟的聚焦金融行业的区块链底层平台
...
* [Nervos](https://github.com/nervosnetwork/ckb) ⭐ 1,219 | 🐛 82 | 🌐 Rust | 📅 2026-09-20 公链 Nervos CKB 的底层源码
...
* [Zeppelin](https://github.com/OpenZeppelin/zeppelin-solidity) ⭐ 27,246 | 🐛 363 | 🌐 Solidity | 📅 2026-09-18 用于编写安全的以太坊合约框架
* [Truffle](https://github.com/trufflesuite/truffle) ⚠️ Archived 以太坊Dapp开发脚手架
* [Web3j](https://github.com/web3j/web3j) ⭐ 5,403 | 🐛 153 | 🌐 Java | 📅 2026-09-20 以太坊官方Web3轻量级java SDK
...
* [精通比特币](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,319 | 🐛 191 | 🌐 HTML | 📅 2024-12-26 精通比特币开发Oreilly开源书 [中文翻译版](https://github.com/tianmingyun/MasterBitcoin2CN) ⭐ 1,787 | 🐛 5 | 📅 2024-04-14
* [blockchaindev.org](http://blockchaindev.org/) 区块链创业公司维优CTO的专栏
* [区块链研习社](http://www.jianshu.com/u/30081a05cf95) 比特币源码解读

### Ethereum 以太坊

* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,530 | 🐛 3 | 📅 2026-09-19 精通以太坊开发Oreilly开源书
...
* [web3modal](https://github.com/WalletConnect/web3modal) ⭐ 5,443 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-19 Web3 provider solution for all Wallets
...
* [nostr](https://github.com/nostr-protocol/nostr) ⭐ 12,046 | 🐛 64 | 📅 2025-06-27 Nostr协议目录
...
* [ERC20](https://github.com/ethereum/EIPs/pull/610) ⭐ 13,981 | 🐛 522 | 🌐 Python | 📅 2026-09-20 以太坊的ICO代币标准
