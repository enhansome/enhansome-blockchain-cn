...
*Please read the contribution [guidelines](https://github.com/sindresorhus/awesome/blob/master/contributing.md) ⭐ 506,457 | 🐛 106 | 📅 2026-09-02 before contributing. 请在为本项目贡献信息前仔细阅读 [操作指南](https://github.com/sindresorhus/awesome/blob/master/contributing.md) ⭐ 506,457 | 🐛 106 | 📅 2026-09-02*
...
* [Marbles Project Tutorial: Part One](https://github.com/IBM-Blockchain/marbles/blob/master/docs/tutorial_part1.md) ⭐ 1,023 | 🐛 23 | 🌐 JavaScript | 📅 2019-03-28 官方Chaincode案例教程第一部分 *(English)*
* [Marbles Project Tutorial: Part Two](https://github.com/IBM-Blockchain/marbles/blob/master/docs/tutorial_part2.md) ⭐ 1,023 | 🐛 23 | 🌐 JavaScript | 📅 2019-03-28 官方Chaincode案例教程第二部分 *(English)*
...
* [Roadmap of learning blockchain](https://github.com/Blockchain-zju/blockchainer-roadmap) ⭐ 1,393 | 🐛 0 | 📅 2025-01-09
...
* [IPFS](https://github.com/ipfs/go-ipfs) ⭐ 17,139 | 🐛 871 | 🌐 Go | 📅 2026-09-15 IPFS的GO语言实现 [原理](https://github.com/ipfs/ipfs) ⭐ 23,060 | 🐛 8 | 📅 2025-05-01
...
* [NEO](https://github.com/neo-project/neo) ⭐ 3,534 | 🐛 263 | 🌐 C# | 📅 2026-09-14 NEO链源码
* [FISCO-BCOS](https://github.com/FISCO-BCOS/FISCO-BCOS) ⭐ 2,604 | 🐛 415 | 🌐 C++ | 📅 2026-09-15 来自金链盟的聚焦金融行业的区块链底层平台
...
* [Nervos](https://github.com/nervosnetwork/ckb) ⭐ 1,219 | 🐛 83 | 🌐 Rust | 📅 2026-09-16 公链 Nervos CKB 的底层源码
...
* [Zeppelin](https://github.com/OpenZeppelin/zeppelin-solidity) ⭐ 27,242 | 🐛 380 | 🌐 Solidity | 📅 2026-09-15 用于编写安全的以太坊合约框架
* [Truffle](https://github.com/trufflesuite/truffle) ⚠️ Archived 以太坊Dapp开发脚手架
* [Web3j](https://github.com/web3j/web3j) ⭐ 5,404 | 🐛 152 | 🌐 Java | 📅 2026-08-18 以太坊官方Web3轻量级java SDK
* [Embark](https://github.com/embark-framework/embark) ⭐ 3,768 | 🐛 134 | 🌐 JavaScript | 📅 2024-07-30 以太坊Dapp开发框架，支持IPFS、Whisper及Orbit调用
* [Solidity-Coverage](https://github.com/sc-forks/solidity-coverage) ⭐ 1,003 | 🐛 40 | 🌐 JavaScript | 📅 2025-12-11 检测Solidity代码覆盖
...
* [Zokrates](https://github.com/JacobEberhardt/ZoKrates) ⭐ 1,870 | 🐛 115 | 🌐 Rust | 📅 2024-08-01 以太坊使用zkSNARKS工具包(实验用)
...
* [FSolidM](https://cps-vo.org/group/SmartContracts) 可视化智能合约生成工具 [源码](https://github.com/anmavrid/smart-contracts) ⭐ 120 | 🐛 1 | 🌐 JavaScript | 📅 2023-11-03

## DOCUMENT 资料

### BitCoin 比特币

* [精通比特币](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,313 | 🐛 191 | 🌐 HTML | 📅 2024-12-26 精通比特币开发Oreilly开源书 [中文翻译版](https://github.com/tianmingyun/MasterBitcoin2CN) ⭐ 1,785 | 🐛 5 | 📅 2024-04-14
* [blockchaindev.org](http://blockchaindev.org/) 区块链创业公司维优CTO的专栏
* [区块链研习社](http://www.jianshu.com/u/30081a05cf95) 比特币源码解读

### Ethereum 以太坊

* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,532 | 🐛 0 | 📅 2026-08-31 精通以太坊开发Oreilly开源书
* [以太坊开发者工具列表](https://github.com/ConsenSys/ethereum-developer-tools-list/blob/master/README_Chinese.md) ⚠️ Archived 以太坊开发资料收集
* [EthList](https://github.com/Scanate/EthList) ⭐ 3,873 | 🐛 5 | 📅 2026-05-04 以太坊开发相关学习资料收集 *(English)*
...
* [web3modal](https://github.com/WalletConnect/web3modal) ⭐ 5,438 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-15 Web3 provider solution for all Wallets
...
* [Compound](https://compound.finance/governance/comp) Compound 借贷机制 [源码](https://github.com/compound-finance/compound-protocol) ⭐ 2,035 | 🐛 87 | 🌐 TypeScript | 📅 2024-06-10
...
* [nostr](https://github.com/nostr-protocol/nostr) ⭐ 12,037 | 🐛 64 | 📅 2025-06-27 Nostr协议目录
...
* [Aragon](https://aragon.one/) 公司业务 [源码](https://github.com/aragon/aragon-core/tree/master/contracts) ⭐ 678 | 🐛 65 | 🌐 Solidity | 📅 2023-03-08
...
* [ERC20](https://github.com/ethereum/EIPs/pull/610) ⭐ 13,977 | 🐛 517 | 🌐 Python | 📅 2026-09-16 以太坊的ICO代币标准
* [Token Sale](http://vitalik.ca/general/2017/06/09/sales.html) 代币销售模型
* [NFT](https://www.nft.org/) NFT代币

## [Awesome Ethereum](https://github.com/chaozh/awesome-blockchain/tree/master/Ethereum) ⭐ 18,948 | 🐛 17 | 🌐 JavaScript | 📅 2024-02-29

以太坊相关详细开发资源收集

## [Awesome Fabric](https://github.com/chaozh/awesome-blockchain/tree/master/Hyperledger%20Fabric) ⭐ 18,948 | 🐛 17 | 🌐 JavaScript | 📅 2024-02-29
