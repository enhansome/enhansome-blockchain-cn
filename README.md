...
* [Solidity智能合约](https://github.com/WTFAcademy/WTF-Solidity-Internals) ⭐ 60 | 🐛 1 | 🌐 Solidity | 📅 2024-03-08 介绍Solidity智能合约中的存储布局，内存布局，以及ABI编码规则，帮助大家理解Solidity的内部规则。
...
* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,516 | 🐛 1 | 📅 2026-05-13 精通以太坊开发Oreilly开源书
...
* [web3modal](https://github.com/WalletConnect/web3modal) ⭐ 5,431 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-13 Web3 provider solution for all Wallets
...
* [Compound](https://compound.finance/governance/comp) Compound 借贷机制 [源码](https://github.com/compound-finance/compound-protocol) ⭐ 2,040 | 🐛 86 | 🌐 TypeScript | 📅 2024-06-10
